...
export default function Navbar() {
    ...
    return (
        <nav className=' bg-navy w-full h-16 flex justify-center'>
            ...
            <div className={view? 'text-peach bg-navy mt-16 justify-between gap-12 items-center absolute max-sm:block transition-all duration-500' : 'text-peach bg-navy mt-[-200px] justify-between gap-12 items-center absolute max-sm:block  transition-all duration-500'}>
                <a href="#inicio"><h3 className='button-hover w-screen pl-8 py-2'>INICIO</h3></a>
                <a href="#calorias"><h3 className='button-hover w-screen pl-8 py-2'>CALORIAS</h3></a>
                <a href="#gorduras"><h3 className='button-hover w-screen pl-8 py-2'>GORDURA</h3></a>
            </div>
